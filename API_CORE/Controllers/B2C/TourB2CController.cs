        ...
        public async Task<ActionResult> GetTourDetailByID(string token)
        {
            ...
            try
            {
                ...
                if (CommonHelper.GetParamWithKey(token, out objParr, configuration["DataBaseConfig:key_api:b2c"]))
                {
                    ...
                    var cache_name = CacheName.B2C_TOUR_TourID + id;
        ...
        public async Task<ActionResult> GetListTourDetail(string token)
        {
            ...
            try
            {
                ...
                if (CommonHelper.GetParamWithKey(token, out objParr, configuration["DataBaseConfig:key_api:b2c"]))
                {
                    ...
                    var cache_name = CacheName.B2C_TOUR_ListTour + tourtype+pageindex+pagesize;
                    var str = redisService.Get(cache_name, db_index);
                    if (str != null && str.Trim() != "")
                    {
        ...
        public async Task<ActionResult> GetListTourSearch(string token)
        {
            ...
            try
            {
                ...
                if (CommonHelper.GetParamWithKey(token, out objParr, configuration["DataBaseConfig:key_api:b2c"]))
                {
                    ...
                    int db_index = Convert.ToInt32(configuration["Redis:Database:db_core"]);
                    var cache_name = CacheName.B2C_TOUR_Search + startpoint + endpoint + tourtype+ pagesize+ pageindex;
                    var str = redisService.Get(cache_name, db_index);
                    if (str != null && str.Trim() != "")
                    {
                    ...
                    var listnational = await _tourIESRepository.GetListTour(startpoint, endpoint, tourtype, transport, pageindex, pagesize,true,false);
        ...
        public async Task<ActionResult> GetListbyTourId(string token)
        {
            ...
            try
            {
                ...
                if (CommonHelper.GetParamWithKey(token, out objParr, configuration["DataBaseConfig:key_api:b2c"]))
                {
                    ...
                    int db_index = Convert.ToInt32(configuration["Redis:Database:db_core"]);
                    var cache_name = CacheName.B2C_TOUR_ListTour + CommonHelper.MD5Hash(tourid);
                    var str = redisService.Get(cache_name, db_index);
                    if (str != null && str.Trim() != "")
                    {
                        List<ListTourProductViewModel> model = JsonConvert.DeserializeObject<List<ListTourProductViewModel>>(str);
        ...
        public async Task<ActionResult> GetListFavoriteTourProduct(string token)
        {
            ...
            try
            {
                ...
                if (CommonHelper.GetParamWithKey(token, out objParr, configuration["DataBaseConfig:key_api:b2c"]))
                {
                    ...
                    int db_index = Convert.ToInt32(configuration["Redis:Database:db_core"]);
                    var cache_name = CacheName.B2C_TOUR_Favourites + pageindex+pagesize;
                    var str = redisService.Get(cache_name, db_index);
                    if (str != null && str.Trim() != "")
                    {
                        List<ListTourProductViewModel> model = JsonConvert.DeserializeObject<List<ListTourProductViewModel>>(str);
        ...
        public async Task<ActionResult> GetStartLocation(string token)
        {
            ...
            try
            {
                ...
                if (CommonHelper.GetParamWithKey(token, out objParr, configuration["DataBaseConfig:key_api:b2c"]))
                {
                    ...
                    var cache_name = CacheName.B2C_TOUR_LocationStart + tourtype;
        ...
        public async Task<ActionResult> LocationEnd(string token)
        {
            ...
            try
            {
                ...
                if (CommonHelper.GetParamWithKey(token, out objParr, configuration["DataBaseConfig:key_api:b2c"]))
                {
                    ...
                    var cache_name = CacheName.B2C_TOUR_LocationEnd + tourtype+start_point;
                    //-- Đọc từ cache, nếu có trả kết quả:
                    var str = redisService.Get(cache_name, db_index);
                    if (str != null && str.Trim() != "")
                    {
        ...
        public async Task<ActionResult> SearchTour(string token)
        {
            ...
            try
            {
                ...
                if (CommonHelper.GetParamWithKey(token, out objParr, configuration["DataBaseConfig:key_api:b2c"]))
                {
                    ...
                    var list_tour = await _TourRepository.GetListTourProduct(tourtype.ToString(), pagesize, pageindex, startpoint, endpoint,transport);
                    if (list_tour != null && list_tour.Count > 0)
                    {
        ...
        public async Task<ActionResult> GetTourDetail(string token)
        {
            ...
            try
            {
                ...
                if (CommonHelper.GetParamWithKey(token, out objParr, configuration["DataBaseConfig:key_api:b2c"]))
                {
                    ...
                    int db_index = Convert.ToInt32(configuration["DataBaseConfig:Redis:Database:db_core"]);
                    var cache_name = CacheName.B2C_TOUR_Detail + id+"5";
                    //-- Đọc từ cache, nếu có trả kết quả:
                    var str = redisService.Get(cache_name, db_index);
                    if (str != null && str.Trim() != "")
                    {
                    ...
                    var packages = await _TourRepository.GetListTourProgramPackagesByTourProductId(id,"5");
        ...
        public async Task<ActionResult> GetListTourPosition(string token)
        {
            ...
            try
            {
                ...
                if (CommonHelper.GetParamWithKey(token, out objParr, configuration["DataBaseConfig:key_api:b2c"]))
                {
                    ...
                    int db_index = Convert.ToInt32(configuration["Redis:Database:db_core"]);
                    var cache_name = CacheName.B2C_TOUR_ListTour_POSITION + tourtype + pageindex + pagesize;
                    var str = redisService.Get(cache_name, db_index);
                    if (str != null && str.Trim() != "")
                    {
                        List<ListTourProductViewModel> model = JsonConvert.DeserializeObject<List<ListTourProductViewModel>>(str);
