    ...
    public class MailService
    {
        ...
        public MailService(IConfiguration _configuration, IContactClientRepository _contactClientRepository, IVinWonderBookingRepository vinWonderBookingRepository,
            IClientRepository _clientRepository, IFlyBookingDetailRepository _flyBookingDetailRepository,
             ...
             IOtherBookingRepository _otherBookingRepository, ITourRepository _tourRepository, IAllCodeRepository _allCodeRepository, IUserRepository _userRepository, IContractPayRepository _contractPayRepository, IVoucherRepository _voucherRepository, INotifyRepository _notifyRepository)
        {
