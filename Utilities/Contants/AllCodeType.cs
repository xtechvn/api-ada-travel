...
namespace Utilities.Contants
{
    public struct AllCodeType
    {
        ...
        public static string TELEGRAM_BOT = "TELEGRAM_BOT";
        ...
        public static string TYPE_OF_ROOM = "TYPE_OF_ROOM";
        public static string BOOKING_HOTEL_STATUS = "BOOKING_HOTEL_STATUS";
        public static string DEPOSIT_STATUS = "DEPOSIT_STATUS";
        public static string GROUP_PERMISSION_B2B = "GROUP_PERMISSION_B2B";
        public static string CLIENT_TYPE_ACCOUNT_NUMBER = "CLIENT_TYPE_ACCOUNT_NUMBER";
    }
